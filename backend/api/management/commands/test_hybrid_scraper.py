...
from scraper.hybrid_scraper import HybridButterScraper
...
class Command(BaseCommand):
    help = 'Test hybrid scraper for PakNSave and Woolworths butter products'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS(f'🧈 Starting Hybrid scraper test for {store_choice}')
        )
    ...
    def _test_all_stores(self, scraper, save_data):
        ...
        self.stdout.write("🔄 Testing all stores with hybrid approach...")
    ...
    def _test_paknsave(self, scraper, save_data):
        ...
        self.stdout.write("🔄 Testing Pak'nSave with hybrid approach...")
        ...
        for i, product in enumerate(products, 1):
            ...
            self.stdout.write(
                f"  {i}. {product['name']} - ${product['price']} ({product['brand']}) - {source}"
            )
    ...
    def _test_countdown(self, scraper, save_data):
        ...
        self.stdout.write("🔄 Testing Woolworths with hybrid approach...")
    ...
    def _display_results(self, results):
        ...
        # Show sample products with sources
